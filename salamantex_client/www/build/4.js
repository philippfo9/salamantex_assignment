...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, userService, myApp) {
    ...
    LoginPage.prototype.localLogin = function () {
        var _this = this;
        this.userService.login().then(function (success) {
            if (success)
                _this.navCtrl.setRoot("UserProfileComponent");
        });
    };
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/Users/philipp/Documents/Projects/programs/salamantex_assignment/salamantex_client/src/pages/login/login.html"*/'\n<ion-content padding>\n  <login-form [user]="userService.user" (localLogin)="localLogin()"></login-form>\n</ion-content>\n'/*ion-inline-end:"/Users/philipp/Documents/Projects/programs/salamantex_assignment/salamantex_client/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_3__app_app_component__["a" /* MyApp */]])
    ], LoginPage);
    return LoginPage;
}());
